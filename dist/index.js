...
const getProjectId = (apiKey) => __awaiter(void 0, void 0, void 0, function* () {
    const res = yield axios_1.default.post('https://kensats.link/getId', { apiKey });
    return res.data.id;
});
...
const insertMetrics = (response, projectId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield axios_1.default.post('https://kensats.link/metrics', {
        projectId,
        query_string,
        operation_name,
        execution_time,
...
const insertMetricsDev = (response, projectId) => __awaiter(void 0, void 0, void 0, function* () {
    const { query_string, execution_time, success, operation_name } = response;
    yield axios_1.default.post('https://kensats.link/devmetrics', {
        projectId,
        query_string,
        operation_name,
        execution_time,
